...
export const userData =
  JSON.parse(localStorage.getItem(LOCALSTORAGE_ITEM_NAME) as string) || {};
...
async function updateUserAnimelist(username: string) {
...
export const saveUserData = (username: string, dontShowAgain?: boolean) => {
  if (username) {
